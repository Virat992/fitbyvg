...
export default function WorkoutInfo({ workout, onBack, onStart }) {
  return (
    <div className="bg-white mt-5 rounded-2xl shadow-lg p-4 md:p-6">
      {/* Back button */}
      <button
      ...
      {/* Start Button */}
      <button
        className="w-full py-3 md:py-4 bg-cyan-600 text-white font-bold rounded-2xl hover:bg-cyan-700 transition text-sm md:text-base"
        onClick={onStart}
      >
        Start Program
      </button>
